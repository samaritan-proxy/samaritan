...
// Source: github.com/samaritan-proxy/samaritan/pb/api (interfaces: DiscoveryServiceClient,DiscoveryService_StreamDependencyClient,DiscoveryService_StreamSvcConfigsClient,DiscoveryService_StreamSvcEndpointsClient)
...
// StreamDependency mocks base method
func (m *MockDiscoveryServiceClient) StreamDependency(arg0 context.Context, arg1 *api.DependencyRequest, arg2 ...grpc.CallOption) (api.DiscoveryService_StreamDependencyClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "StreamDependency", varargs...)
	ret0, _ := ret[0].(api.DiscoveryService_StreamDependencyClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// StreamDependency indicates an expected call of StreamDependency
func (mr *MockDiscoveryServiceClientMockRecorder) StreamDependency(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StreamDependency", reflect.TypeOf((*MockDiscoveryServiceClient)(nil).StreamDependency), varargs...)
}
...
// MockDiscoveryService_StreamDependencyClient is a mock of DiscoveryService_StreamDependencyClient interface
type MockDiscoveryService_StreamDependencyClient struct {
	ctrl     *gomock.Controller
	recorder *MockDiscoveryService_StreamDependencyClientMockRecorder
}

// MockDiscoveryService_StreamDependencyClientMockRecorder is the mock recorder for MockDiscoveryService_StreamDependencyClient
type MockDiscoveryService_StreamDependencyClientMockRecorder struct {
	mock *MockDiscoveryService_StreamDependencyClient
}

// NewMockDiscoveryService_StreamDependencyClient creates a new mock instance
func NewMockDiscoveryService_StreamDependencyClient(ctrl *gomock.Controller) *MockDiscoveryService_StreamDependencyClient {
	mock := &MockDiscoveryService_StreamDependencyClient{ctrl: ctrl}
	mock.recorder = &MockDiscoveryService_StreamDependencyClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockDiscoveryService_StreamDependencyClient) EXPECT() *MockDiscoveryService_StreamDependencyClientMockRecorder {
	return m.recorder
}

// CloseSend mocks base method
func (m *MockDiscoveryService_StreamDependencyClient) CloseSend() error {
	m.ctrl.T.Helper()
...
func (mr *MockDiscoveryService_StreamDependencyClientMockRecorder) CloseSend() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseSend", reflect.TypeOf((*MockDiscoveryService_StreamDependencyClient)(nil).CloseSend))
}

// Context mocks base method
func (m *MockDiscoveryService_StreamDependencyClient) Context() context.Context {
	m.ctrl.T.Helper()
...
func (mr *MockDiscoveryService_StreamDependencyClientMockRecorder) Context() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Context", reflect.TypeOf((*MockDiscoveryService_StreamDependencyClient)(nil).Context))
}

// Header mocks base method
func (m *MockDiscoveryService_StreamDependencyClient) Header() (metadata.MD, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDiscoveryService_StreamDependencyClientMockRecorder) Header() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Header", reflect.TypeOf((*MockDiscoveryService_StreamDependencyClient)(nil).Header))
}

// Recv mocks base method
func (m *MockDiscoveryService_StreamDependencyClient) Recv() (*api.DependencyResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*api.DependencyResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Recv indicates an expected call of Recv
func (mr *MockDiscoveryService_StreamDependencyClientMockRecorder) Recv() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Recv", reflect.TypeOf((*MockDiscoveryService_StreamDependencyClient)(nil).Recv))
}

// RecvMsg mocks base method
func (m *MockDiscoveryService_StreamDependencyClient) RecvMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockDiscoveryService_StreamDependencyClientMockRecorder) RecvMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockDiscoveryService_StreamDependencyClient)(nil).RecvMsg), arg0)
}

// SendMsg mocks base method
func (m *MockDiscoveryService_StreamDependencyClient) SendMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockDiscoveryService_StreamDependencyClientMockRecorder) SendMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockDiscoveryService_StreamDependencyClient)(nil).SendMsg), arg0)
}

// Trailer mocks base method
func (m *MockDiscoveryService_StreamDependencyClient) Trailer() metadata.MD {
	m.ctrl.T.Helper()
...
func (mr *MockDiscoveryService_StreamDependencyClientMockRecorder) Trailer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Trailer", reflect.TypeOf((*MockDiscoveryService_StreamDependencyClient)(nil).Trailer))
}
